...
<html lang="en">
  ...
  <body>
    ...
    <?php if($error) {?><div class="alert alert-error"><a class="close" data-dismiss="alert">×</a><strong>Error!</strong><?php echo $error_msg;?></div><?php } ?>
    <?php if(validation_errors()) {?><div class="alert alert-info"><a class="close" data-dismiss="alert">×</a><strong><?php echo validation_errors(); ?></strong></div><?php }?>
    <?php if($info) {?><div class="alert alert-success"><a class="close" data-dismiss="alert">×</a><strong>Success!</strong><?php echo $info_msg;?></div><?php } ?>    
    
    <div id="loginBox">
    
    					 <?php $attibuts= array('id'		=>	'loginForm',
							   'name'	=>	'loginForm',
							    'class'=>	'form-signin'					   
							   );
							   echo form_open('members/forgotPassword',$attibuts);?>
                         ...
                         <!-- <form id="loginForm">-->
                            <fieldset id="body">
                              ...
                              <input class='btn btn-large btn-primary' type="submit" id="login" value="Resend" />
                            
                                  <span class="resend"><a href="<?php echo base_url().'members/login';?>">Back to login ›› </a></span>
                            </fieldset>
